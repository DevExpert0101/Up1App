					...
					<div className="container">
						<div className="row align-items-center">
							<div className="col-12 text-center">
								<h1 className="" >Elevating Predictive Insights to New Heights</h1>
								<p className="text text-primary " >Welcome to the Future of Decentralized Prediction Markets</p>
								<Link to={"/about-us"} className="btn space-lg btn-gradient btn-shadow btn-primary " >Join Now</Link>
