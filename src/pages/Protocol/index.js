              ...
              <div className="">
                <div className="dz-media">
                  <div className="row m-b70">
                    <img src={decentralized1} className='col-4' changeClass="image-box-1" alt="decentral"/>
                    <img src={decentralized2} className='col-4' changeClass="image-box-2" alt="decentral"/>
                    <img src={decentralized1} className='col-4' changeClass="image-box-1" alt="decentral"/>
                  </div>                                    
                </div>
              </div>
