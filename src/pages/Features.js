            ...
            <div className="row about-bx2 style-1 align-items-center">
              ...
              <div className="col-lg-6 about-content ps-lg-5 m-b100">
                <div className="section-head">
                  <h2 className="title">Decentralized Infrastructure</h2>
              ...
              <div className="col-lg-6 about-content ps-lg-5 m-b100">
                <div className="section-head">
                  <h2 className="title">Accurate Insight</h2>
                  <p className="m-0 lh-base">
              ...
              <div className="col-lg-6">
                <div className="dz-media">
                  <div className="row align-items-end m-b70">
                    <ImageBox image={community1} changeClass="image-box-1" />
                    <ImageBox image={community2} changeClass="image-box-2" />
                  </div>
                </div>
              </div>
              <div className="col-lg-6 about-content ps-lg-5 m-b100">
                <div className="section-head">
                  <h2 className="title">Community Engagement</h2>
                  <p className="m-0 lh-base">
                    Showcase the vibrant community within UP1, encouraging
                    interaction and knowledge sharing. Illustrate how users
                    participate, create markets, place wagers, and engage with
                    other enthusiasts.
                  </p>
                </div>
